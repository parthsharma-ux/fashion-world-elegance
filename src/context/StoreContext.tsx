...
const defaultReviews: Review[] = [
  { id: '1', name: 'Priya Sharma', avatar: 'PS', rating: 5, comment: 'Absolutely beautiful kurti! The fabric quality is amazing and fits perfectly.', date: '2026-01-15' },
  { id: '2', name: 'Anita Gupta', avatar: 'AG', rating: 5, comment: 'Fast delivery and excellent customer service. Will definitely order again!', date: '2026-01-10' },
  { id: '3', name: 'Meera Patel', avatar: 'MP', rating: 4, comment: 'Love the designs! Very comfortable for daily wear.', date: '2026-01-08' },
  { id: '4', name: 'Kavita Singh', avatar: 'KS', rating: 5, comment: 'The festive collection is stunning. Got so many compliments!', date: '2026-01-05' },
];
